...
export interface IEllipseVariant {
  ellipse: "primary" | "secondary" | "info" | undefined;
  border: string;
}

export interface IEllipseRatioProps {
  sx?: SxProps<Theme>;
  value: number;
}
const getEllipseVariant = (value: number): IEllipseVariant => {
...
export function EllipseRatio({ sx, value }: IEllipseRatioProps) {
